...
public class EscanerSalidaActivity extends Activity implements ZBarScannerView.ResultHandler  {
    direccionIP URL;
    String direIP;
    ...
    private void endGuardar(String auxcp, String date, String codigoH) {
        ...
        String url =direIP+"registroAsisSalida.php?acp="+auxcp+"&hrs="+newdate+"&codh="+codigoH;
